...
for _, c in pairs(colors) do
  ...
  beam.graphics_set.beam.body[1].tint = c.tint
  beam.graphics_set.beam.head.tint = c.tint
  beam.graphics_set.beam.tail.tint = c.tint
  beam.graphics_set.beam.ending.tint = c.tint
  beam.graphics_set.beam.ending.hr_version.tint = c.tint
  beam.graphics_set.beam.start.tint = c.tint
  beam.graphics_set.beam.start.hr_version.tint = c.tint
